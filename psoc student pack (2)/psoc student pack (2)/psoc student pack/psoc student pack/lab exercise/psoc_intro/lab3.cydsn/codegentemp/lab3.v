...
module top ;
	...
	cy_clock_v1_0
		#(.id("7815e4b7-b5b5-4537-97c0-75149dd0fcc2"),
		  .source_clock_id("CEF43CFB-0213-49b9-B980-2FFAB81C5B47"),
		  .divisor(0),
		  .period("1000000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__PIN_OUTPUT_net;
	wire [0:0] tmpFB_0__PIN_OUTPUT_net;
	wire [0:0] tmpIO_0__PIN_OUTPUT_net;
	wire [0:0] tmpINTERRUPT_0__PIN_OUTPUT_net;
	electrical [0:0] tmpSIOVREF__PIN_OUTPUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_OUTPUT
		 (.oe(tmpOE__PIN_OUTPUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_OUTPUT_net[0:0]}),
	...
	assign tmpOE__PIN_OUTPUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_2 (
        .z(Net_131));

    Timer_v2_80_1 Timer_2 (
        .reset(Net_131),
        .interrupt(Net_132),
        .enable(1'b1),
        .trigger(1'b1),
	...
	wire [0:0] tmpOE__PIN_OUTPUT_2_net;
	wire [0:0] tmpFB_0__PIN_OUTPUT_2_net;
	wire [0:0] tmpIO_0__PIN_OUTPUT_2_net;
	wire [0:0] tmpINTERRUPT_0__PIN_OUTPUT_2_net;
	electrical [0:0] tmpSIOVREF__PIN_OUTPUT_2_net;

	cy_psoc3_pins_v1_10
		#(.id("c4dded15-0cca-4485-afb8-ca904cd1ec9b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_OUTPUT_2
		 (.oe(tmpOE__PIN_OUTPUT_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_OUTPUT_2_net[0:0]}),
		  .io({tmpIO_0__PIN_OUTPUT_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_OUTPUT_2_net),
		  .interrupt({tmpINTERRUPT_0__PIN_OUTPUT_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_OUTPUT_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
